<template>
    <div class="flex flex-1 flex-col justify-between py-4">
        <h1 class="text-zsi-500 text-lg font-moreno font-semibold mt-3" :to="{ name: 'Game' }">
            Skupina {{ group }}
        </h1>
        ...
        <div class="text-[1.0625rem] flex flex-col gap-8 px-4">
            ...
            <p>
                Dojdete nezávisle na sobě ke stejným závěrům?
            </p>
            <p>
...
import groupIntro from '../assets/group-intro.png';
